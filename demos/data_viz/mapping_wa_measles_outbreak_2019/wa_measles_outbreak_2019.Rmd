...
```{r}
wa_coverage <- wa_coverage %>% 
  mutate(Popup = paste0('<dl>', 
    '<dt>', 'School Name',      '</dt><dd>', `School Name`,     '</dd>',
    '<dt>', 'School District',  '</dt><dd>', `School District`, '</dd>',
    '<dt>', 'Enrollment',       '</dt><dd>', `Enrollment`,      '</dd>',
    '<dt>', 'Percent Complete', '</dt><dd>', `Percent`,         '</dd>',
    '<dt>', 'Percent Exempt',   '</dt><dd>', `Exempt`,          '</dd>', 
    '</dl>'))
```

...
* There were `r edu` sites at schools (`r paste0(round(100*edu/tot), '%')`).
* There were `r med` sites at medical facilities (`r paste0(round(100*med/tot), '%')`).

We also know from [county reports](https://www.clark.wa.gov/public-health/measles-investigation) that:

* 66 of 71 cases were children age 1-18.
...
This will allow is to see if there are "pockets" of low immunization rates.

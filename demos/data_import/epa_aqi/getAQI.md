...
##  6 Spokane                                           24
##  7 Bremerton-Silverdale-Bainbridge Island            23
##  8 Sunnyside                                         23
##  9 Tacoma-Puyallup                                   23
## 10 Vancouver                                         22
## 11 Chehalis                                          21
## 12 Shelton                                           21
## 13 Bellingham                                        19
## 14 Cascade foothills of King County                  19
## 15 Cascade foothills of east King-Pierce counties    18
```
...
Given the following code which extracts real-time data PM 2.5 data from 
[Washington's Air Monitoring Network](https://fortress.wa.gov/ecy/enviwa/):


```r
pacman::p_load(rvest, purrr, con2aqi)
...
5. Compare the results you found using the code above with the EPA AQI data. You 
...
6. Modify the code to append new data to the output file as shown in the EPA 

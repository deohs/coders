...
We can plot PM2.5 AQI for multiple sensor locations in Seattle using the [ggmap](https://cran.r-project.org/web/packages/ggmap/index.html) package. 

The [Air quality Index (AQI)](https://www.airnow.gov/aqi/aqi-basics/) is calculated using the [con2aqi](https://cran.r-project.org/web/packages/con2aqi/index.html) package. 

...
# Construct data folder path using a heuristic
onedrive_path <- Sys.getenv('OneDrive')
alt_onedrive_path <- file.path(Sys.getenv('HOME'), 
                               ifelse(.Platform$OS.type == "windows", '..', ''), 
                               'OneDrive')
onedrive_path <- ifelse(onedrive_path != "", onedrive_path, alt_onedrive_path)
